    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="w-full max-w-md bg-gray-800/50 backdrop-blur-lg border border-gray-700 p-8 rounded-3xl shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Access your cricket dashboard</p>
        </div>
        ...
        <form onSubmit={onSubmitForm} className="space-y-5">
          ...
          <button 
            disabled={loading}
            className={`w-full py-4 rounded-xl font-bold text-white shadow-lg transition-all transform hover:scale-[1.02] ${loginType === 'admin' ? 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:shadow-purple-500/30' : 'bg-gradient-to-r from-blue-600 to-cyan-600 hover:shadow-blue-500/30'}`}
          >
